    ...
    def load_nucleus(self, dataset_dir, subset):
        ...
        for image_id in image_ids:
            self.add_image(
                "nucleus",
                image_id=image_id,
                path=glob.glob(os.path.join(dataset_dir, image_id, "images/*.png"))[0])
...
def detect(model, dataset_dir, subset):
    ...
    #hdfs_dir='hdfs://133.186.143.138:9000/user/$USERNAME/'
   ...
   # from pandas import Dataframe
    for image_id in dataset.image_ids:
       ...
       # print(r['class_ids'])
        ...
        plt.savefig("{}/{}.png".format(submit_dir,dataset.image_info[image_id]['path'].split('/')[-1][:-4] ))
